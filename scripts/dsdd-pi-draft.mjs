...
export function promptFor(input) {
  ...
  return [
    ...
    "Every repository path you place in backticks must exist in the current repository and must come from your bounded read/grep/find/ls inspection.",
    "Do not write speculative phrases such as 'if a function exists', 'there might be', 'e.g. a file', or 'or similar functions'.",
    "If bounded inspection does not find an evidence-backed file, symbol, primitive, owner, or test, state that it was not found instead of guessing.",
    ...
    "List only evidence-backed candidates discovered during this run; distinguish inspect vs likely change. If none were found, write 'None found from bounded inspection.'.",
