...
import { WEBMCP_STANDARD_SURFACE_TARGETS } from "./webmcp-surface-capture-registry.mjs";

const PURPOSES = Object.freeze({
  get_current_surface: "Read the currently rendered PlotPickle surface.",
  list_available_surfaces: "List bounded standard surfaces and visible navigation choices available to UAT.",
  open_surface: "Open one bounded standard surface through the existing visible interface path.",
...
export const WEBMCP_UAT_SKILL_POLICY = Object.freeze({
  ...
  executor: "webmcp-standard-surface-catalogue",
  authority: "read-navigation-visual-only",
  allowedTargets: WEBMCP_STANDARD_SURFACE_TARGETS,
