...
async function copyExistingEvidence(repoRoot, runDir) {
  const copied = [];
  for (const relative of STANDARD_EVIDENCE) {
...
export async function finalizeWebMcpFullQaArtifacts({
  ...
  const copiedStandardEvidence = await copyExistingEvidence(repoRoot, runDir);
