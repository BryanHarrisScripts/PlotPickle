...
export function coreRecommendations(project: PlotPickleProject, routeId: CoreRouteId): CoreRecommendation[] {
  ...
  const dialogueElements = project.screenplay.draftElements.filter((item) => item.type === "dialogue" || item.type === "dual-dialogue");
