# 2410 Managed runtime modernization

Promote the live Mastra pin from 1.67.0 to 1.69.0 and the managed Pi pin from 0.87.0 to 0.87.1. Regenerate both npm lockfiles. Keep BUZZ Desktop at the separately completed 0.5.25 fallback; this issue does not alter its relay. ComfyUI, Ollama, and Cline remain user managed. Node.js, whisper.cpp, Portless, and Lazy Frames retain their reviewed holds.
