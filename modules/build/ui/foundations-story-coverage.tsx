...
import FoundationsStoryWorkflowPanel from "../../story-workflow/ui/foundations-story-workflow-panel";
import {
...
export default function FoundationsStoryCoverage({
  ...
  return (
    <>
      <FoundationsStoryWorkflowPanel curriculum={curriculum} project={project} />
