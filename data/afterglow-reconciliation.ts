...
export const afterglowVersions = [
  ...
  { id: "v9", label: "Afterglow v9 — Most Complete 2023 Baseline", status: "complete-baseline" as AfterglowVersionStatus, scope: "Most complete screenplay baseline; its FDX contains 21 explicit titled source sections, while PlotPickle normalizes passages onto the 24-Block planning grid without asserting 24 authored source Blocks", sourcePath: "Afterglow v9 Twitter Rewrite Bryan E. Harris 2023.fdx", sourceSha: "54b5967644c5a41363fa88f57b02473ea758acc2", immutable: true },
