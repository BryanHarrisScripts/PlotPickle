const refs = (topic, ...positions) => Object.freeze({ topic, positions: Object.freeze(positions) });
const course = (id, year, semester, orderInSemester, title, purpose, lessonRefs, advisoryPrerequisites, applicationTargets) => Object.freeze({
  id,
  year,
  semester,
  orderInSemester,
  title,
  purpose,
  lessonRefs: Object.freeze(lessonRefs),
  advisoryPrerequisites: Object.freeze(advisoryPrerequisites),
  applicationTargets: Object.freeze(applicationTargets),
});

export const LEARN_PROGRAM_COURSE_SPECS = Object.freeze([
...
export const LEARN_PROGRAM_SHELL_SPEC = Object.freeze({
  schemaVersion: "1.0",
  issue: 1918,
  ...
  courseCount: 24,
  semesters: Object.freeze(Array.from({ length: 6 }, (_, index) => {
    const semester = index + 1;
    return Object.freeze({
      id: `semester-${semester}`,
      year: Math.ceil(semester / 2),
      semester,
      courseIds: Object.freeze(LEARN_PROGRAM_COURSE_SPECS.filter((item) => item.semester === semester).map((item) => item.id)),
    });
  })),
});

export default LEARN_PROGRAM_SHELL_SPEC;
