...
export type ConversationalUatState = {
  schemaVersion: 1;
  sessionId: string;
  head: string;
  runtime: "option-3";
  journey: Array<ReturnType<typeof semanticJourneyEvent>>;
...
export function normalizeConversationalUatState(value: unknown, identity = currentConversationalUatIdentity()): ConversationalUatState {
...
export function appendConversationalJourney(state: ConversationalUatState, value: unknown) {
...
export function confirmedFindingNarration(finding: Record<string, any>) {
  return [
...
export function confirmedFindingInterpretation(finding: Record<string, any>) {
  return [
...
export function findingContext(finding: Record<string, any>) {
...
export function pendingConversationalCandidates(state: ConversationalUatState) {
