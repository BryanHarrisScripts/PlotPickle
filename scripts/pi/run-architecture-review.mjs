...
} from "./architecture-review-core.mjs";
...
function parseArgs(argv) {
  ...
  if (!new Set(["impact", "review", "ci"]).has(args.mode)) {
    throw new Error("Usage: node scripts/pi/run-architecture-review.mjs <impact|review|ci> [--base main] [--head HEAD] [--spec docs/brief.md] [--impact-map evidence.json] [--ci-log .artifacts/ci.log] [--output-root path]");
  }
