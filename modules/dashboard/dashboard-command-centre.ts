...
import { projectSectionProgress, sectionHasAlert } from "../../lib/projects/project-progress";
import { deriveDashboardStorageStatus, type DashboardStorageStatus } from "./project-dashboard";
import { LEARNING_MODULE_COUNT, type ProductNavigationId } from "../../lib/product-direction";
...
export function dashboardToneForPercentage(value: number): DashboardTone {
