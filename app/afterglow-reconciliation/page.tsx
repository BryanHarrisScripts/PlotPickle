...
export default function AfterglowReconciliationPage() {
  ...
  return (
    <main className={`${styles.page} standalone-studio-surface`} data-afterglow-reconciliation-workspace="canonical">
      <header className={styles.hero}>
        ...
        <nav><Link data-skin-v1-local-return="true" href="/skin-v1">Back to Dashboard</Link><Link href="/about">About PlotPickle</Link><Link href="/legal">Rights and licensing</Link></nav>
      </header>
