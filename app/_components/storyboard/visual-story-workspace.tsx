  ...
  return (
    ...
    >
      ...
      <footer className={styles.boundary}>
        Projection only. Scene, Beat, Shot and Frame identities remain owned by their existing PlotPickle authorities. This surface does not create canon, approve candidates, invent timing or convert technical RenderClips into creative Shots.
      </footer>
    </section>
  );
}
