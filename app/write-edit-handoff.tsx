...
export default function WriteEditHandoff() {
  ...
  function openEdit() {
    ...
    // Home persists canonical project changes after a short debounce. Waiting here
    // ensures the Edit route reads the latest screenplay rather than a stale snapshot.
