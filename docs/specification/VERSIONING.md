...
The application version identifies the installed build. It does not replace or regenerate the durable `pp_studio_XXXXXXXX` Node ID, which remains stable across ordinary pulls, builds, restarts and updates.
