...
export function bundledLtxManifest(): LtxManifest {
  return {
    ...
    source: "https://github.com/Lightricks/ComfyUI-LTXVideo/blob/36fdaf500b3cd6f7fa8b2dfec36e984746e630a2/example_workflows/low_level/ltxvideo-i2v-distilled.json",
    ...
    workflow: {
      ...
      "10": { class_type: "StringToFloatList", inputs: { string: "1.0000, 0.9937, 0.9875, 0.9812, 0.9750, 0.9094, 0.7250, 0.4219, 0.0" } },
