...
export const SITEMAP_RENDERED_ROUTES = Object.freeze([
  ...
  { id: "create-story-map", path: "/story-map", area: "create", destination: "story-map" },
  { id: "support-curriculum", path: "/core-curriculum", area: "settings", destination: "core-curriculum" },
