...
export function auditContinuitySnapshot(screen, snapshot, baseline = null) {
  ...
  if (workspaceScreen) {
    ...
    if (snapshot?.shell?.designSystem !== "matte-black-antique-gold") findings.push(issue("design-system", "The shared shell is not marked with the approved matte-black/antique-gold design contract."));
