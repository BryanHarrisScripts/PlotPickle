...
const DASHBOARD_MENU: readonly DashboardBbsItem[] = [
  ...
  { id: "help", shortcut: "H", label: "Issue Log", description: "Prepare a PlotPickle Feature, Bug, Design Flaw or Issue" },
  ...
  { id: "open-source", shortcut: "N", label: "Open Source", description: "Review Licensing, Rights, Privacy & Attribution", group: "PROJECT MANAGEMENT" },
