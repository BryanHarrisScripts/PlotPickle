...
export async function runSkinV1MenuContractAudit({ serverUrl, toolRoot, storageStatePath = "" } = {}) {
  ...
  try {
    ...
    await page.keyboard.press("C");
    await page.locator("section[aria-label='Cloud Story Mode setup'] [data-skin-v1-cloud-story-mode='true']").waitFor({ state: "visible", timeout: 20_000 });
    ...
    await page.locator("section[aria-label='Local Story Mode setup'] [data-skin-v1-local-ai='true']").waitFor({ state: "visible", timeout: 30_000 });
