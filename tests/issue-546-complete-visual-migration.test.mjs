...
test("#546 audits every standalone route as well as the canonical workspaces", async () => {
  ...
  for (const route of ["/about", "/afterglow-reconciliation", "/ai-routing", "/buzz", "/characters-in-motion", "/core-curriculum", "/craftloop", "/diagnostics", "/dialogue-in-motion", "/draftlens", "/edit", "/feedback", "/git", "/labs", "/legal", "/pageflow", "/production", "/resonance", "/screenplay-readiness", "/settings/buzz", "/start-here", "/story-craft-essentials", "/structure", "/suggest-report", "/voiceprint", "/welcome", "/worked-examples", "/working-together"]) {
