...
The suggested order is not mandatory. Writers may enter whichever engine addresses the current story problem. The complete Diagnostic Craft workspace is available at `/diagnostics`.
