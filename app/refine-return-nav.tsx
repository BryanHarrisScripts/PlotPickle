...
export default function RefineReturnNav() {
  ...
  return (
    ...
    >
      ...
      <Link data-skin-v1-return="refine" href="/diagnostics" style={{ border: "1px solid #9fbdb7", borderRadius: 999, background: "#eef8f5", padding: "8px 12px", fontWeight: 800, color: "#214b44", textDecoration: "none" }}>Refine menu</Link>
