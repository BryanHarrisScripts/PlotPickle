...
test("the UAT registry is deliberately limited to the active slim product areas", async () => {
  ...
  assert.deepEqual(registry.areas.map((area) => area.id), ["startup", "settings", "community", "foundations-learn", "library", "plan", "build", "wyrmwood"]);
  ...
  assert.equal(registry.areas.find((area) => area.id === "library")?.route, "/?workspace=library");
