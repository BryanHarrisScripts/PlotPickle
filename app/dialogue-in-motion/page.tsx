...
export default function DialogueInMotionPage() {
  ...
  return <main className={`${styles.page} standalone-studio-surface`}>
    <header className={styles.hero}><div><span>Playable dialogue learning and practice system</span><h1>Dialogue in Motion</h1><p>Plan objectives, tactics, subtext, status, speech, silence and action; compare Voiceprints with screenplay evidence; read exchanges aloud; and route bounded passes into Dialogue Lab without changing the script automatically.</p></div><nav><Link href="/?workspace=learn">Back to Learn</Link><Link href="/?workspace=learn">Read & Learn</Link><Link href="/labs">Dialogue Lab</Link></nav></header>
